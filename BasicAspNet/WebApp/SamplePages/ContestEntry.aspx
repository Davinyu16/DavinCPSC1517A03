...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:RequiredFieldValidator ID="RequiredProvince" runat="server" 
                                ErrorMessage="Province is required" Display="None"
                                ControlToValidate="Province" ForeColor="#990000"
                                SetFocusOnError ="true">
    </asp:RequiredFieldValidator>
    ...
    <asp:RegularExpressionValidator ID="RegExPostalCode" runat="server" 
                                    ...
                                    Display="None" ControlToValidate="PostalCode"
    ...
    <asp:RegularExpressionValidator ID="RegExEmailAddress" runat="server" 
                                    ErrorMessage="Invalid email format (T6Y7U0)"
                                    Display="None" ControlToValidate="EmailAddress"
                                    ForeColor="#990000" SetFocusOnError="true"
    ...
    <asp:CompareValidator ID="CompareCheckAnswer" runat="server" 
        ...
        ControlToValidate="CheckAnswer" ForeColor="#990000"
        SetFocusOnError="true" Operator="Equal" ValueToCompare="15" Type="Integer">
    </asp:CompareValidator>
    <%--<asp:CompareValidator ID="CompareCheckAnswer" runat="server" 
        ErrorMessage="Compare to another field validation" Display="None"
        ControlToValidate="CheckAnswer" ForeColor="#990000"
        SetFocusOnError="true" Operator="Equal" ControlToCompare="StreetAddress2" Type="Integer">
    </asp:CompareValidator>--%>
    ...
    <asp:RangeValidator ID="RangeSample" runat="server" 
        ...
        Display="None" ForeColor="#990000" SetFocusOnError="true" ControlToValidate="StreetAddress2"
